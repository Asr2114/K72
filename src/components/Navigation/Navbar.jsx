...
function Navbar() {
  ...
  return (
    <div className='z-4 flex fixed top-0 w-full items-start justify-between'>
        <Link to='/'>
        <div className='lg:p-4 p-2 w-16 lg:w-36'>
        ...
        className='lg:h-13   bg-black h-10 relative lg:w-55 w-45'>
            {/* <h1 className='leading-[0.5vw] mt-[7%] ml-[70%]'>______<br/>
                                             &nbsp;&nbsp;&nbsp; ____</h1> */}
        

        <div ref={navGreenRef} className='absolute top-0 h-0 w-full bg-[#D2FD50] transition-all'>
            <h1 className='lg:leading-[0.5vw] leading-[1vw] mt-[7%] ml-[70%]'>______<br/>
                                             &nbsp;&nbsp;&nbsp; ____</h1>
